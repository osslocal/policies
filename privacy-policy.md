...
- __Application__ refers to Job Se-same, the software program provided by the Company.
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Job Se-same.
...
- __Website__ refers to Job Se-same, accessible from [https://se-same.com](https://se-same.com)
